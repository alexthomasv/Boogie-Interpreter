//! BV-mode (wrapping/masked) builtin semantics — the historical algebra,
//! byte-for-byte. This module is the correct model ONLY for
//! `SemanticsMode::Bv`; `SemanticsMode::Int` dispatches to `super::int`.
